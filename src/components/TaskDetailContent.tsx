...
export const TaskDetailContent: React.FC<TaskDetailContentProps> = ({
    ...
    const currSprint = useSprintStore((state) => state.currSprintState);
        ...
        0: {
            ...
            icon: (
                ...
                >
                    <path
                        fillRule="evenodd"
                        d="M10 17a.75.75 0 01-.75-.75V5.612L7.03 7.83a.75.75 0 01-1.06-1.06l3.25-3.25a.75.75 0 011.06 0l3.25 3.25a.75.75 0 11-1.06 1.06L10.75 5.612V16.25A.75.75 0 0110 17z"
                        clipRule="evenodd"
                    />
                </svg>
            ),
        ...
        2: {
            ...
            icon: (
                ...
                >
                    <path
                        fillRule="evenodd"
                        d="M10 3a.75.75 0 01.75.75v10.638l2.22-2.22a.75.75 0 111.06 1.06l-3.25 3.25a.75.75 0 01-1.06 0L6.47 12.28a.75.75 0 111.06-1.06l2.22 2.22V3.75A.75.75 0 0110 3z"
                        clipRule="evenodd"
                    />
                </svg>
            ),
    ...
    const currentPriority =
        priorityMap[task.priority as keyof typeof priorityMap] || priorityMap[2];
    ...
    const currentType =
        typeMap[task.type as keyof typeof typeMap] || typeMap["task"];

    let navigateUrl = "/"
    if (currSprint.type === "Success" && currSprint.data?.data) {
        navigateUrl = `/sprint/${currSprint.data.data.id}`;
    }
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-x-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-8">
                            ...
                            {/* Comment Box and LogItems would go here */}
